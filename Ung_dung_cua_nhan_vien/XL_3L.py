...
def Tao_page_HTML_Giao_dien_Nhan_vien(Nhan_vien):
    KhungHTML = Doc_Khung_HTML()
    chuoiHTML = Tao_chuoi_HTML_Menu_Chinh() + Tao_chuoi_HTML_Thuc_don_Nhan_vien(Nhan_vien) + Tao_chuoi_HTML_Thong_tin_Nhan_vien(Nhan_vien)
    Chuoi_HTML = KhungHTML.replace("Chuoi_HTML",chuoiHTML)
    return Chuoi_HTML
...
def Tao_chuoi_HTML_Menu_Chinh():
    chuoi_thuc_don = f'''
            <div class="row">
            <a class="btn btn-danger" href="/Ho_so" style="margin:5px">Hồ sơ nhân viên</a>
